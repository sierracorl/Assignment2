...
#URL for Twitter favorites - JSON file
json_url = "https://foyzulhassan.github.io/files/favs.json"

# Read & parse JSON file from URL
...
def get_link():
    ...
    for item in data_json:
        tweetLink = []
        matches = re.findall(r'http[s]?://(?:[a-zA-Z]|[0-9]|[$-_@.&+]|[!*\(\),]|(?:%[0-9a-fA-F][0-9a-fA-F]))+', item['all_text'])
